...
?>
<div class="bg-image" style="background-image: url('images/bg_1.jpg');"></div>
    ...
    <div class="container">
        <div class="col-md-4 col-md-offset-1 menu-panel">
            ...
            <div class="mp-body" style="padding-top: 1%;">
                ...
                <?= Html::a('Registar', ['site/signup', 'check' => '0'], ['class' => 'btn btn-blue btn-block btn-flat']); ?>
            </div>
        </div>
        <div class="col-md-4 col-md-offset-2 menu-panel">
            ...
            <div class="mp-body" style="padding-top: 1%;">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                <?= Html::a('Registar', ['site/signup', 'check' => '1'], ['class' => 'btn btn-orange btn-block btn-flat']); ?>
            </div>
        </div>
    </div>
</section>
