        ...
        <div class="col-md-4 col-md-offset-1">
            <div class="menu-panel">
                ...
                <div class="mp-body" style="padding-top: 1%;">
                    ...
                    <?= Html::a('Registar', ['user/registration', 'signupType' => User::TYPE_ADOPTER], ['class' => 'btn btn-blue btn-large btn-block btn-flat']); ?>
                </div>
            </div>
        </div>
        <div class="col-md-4 col-md-offset-2">
            <div class="menu-panel">
                ...
                <div class="mp-body" style="padding-top: 1%;">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    <?= Html::a('Registar', ['user/registration', 'signupType' => User::TYPE_KENNEL], ['class' => 'btn btn-orange btn-large btn-block btn-flat']); ?>
                </div>
            </div>
        </div>
    </div>
